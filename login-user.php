...
<div class="header">
                ...
                <div class="col-md-4 offset-md-4 form login-form">
                    <form action="login-user.php" method="POST" autocomplete="">
                        ...
                        <?php if (isset($_GET['reset'])): ?>
                            <div class="alert alert-success text-center" style="font-size:14px">Password reset successfully! Please log in.</div>
                        <?php endif; ?>
                        <?php
                        if(count($errors) > 0){
                            ?>
    ...
    <p>Waste Management system | <?php echo date('Y'); ?> | 
         ...
         <a href="adminlogin.php"> <i class="fa fa-lock" aria-hidden="true"> Login As Admin</i></a>
